...
{
    logger->debug("eval {} with params{} on input{}", *this, logging::pprint(&p), logging::pprint(&x));
...
{
    logger->debug("eval {} with params{} on input{}", *this, logging::pprint(&p), logging::pprint(&xy));
