	       ...
	       double refC1, double refC2, double refpixC1, double refpixC2) 
{
  ...
  double crefpixC1 = refpixC1;
  double crefpixC2 = refpixC2;
  if (nrows %2 ==0)
	  crefpixC1+=0.5;
  if (ncols %2 ==0)
	  crefpixC2+=0.5;
  crefpixC1 = nrows-1-crefpixC1+1;
  crefpixC2 += 1;
  ...
  pFits->pHDU().addKey("CRPIX1", crefpixC1, "Reference pixel on axis 1");
  pFits->pHDU().addKey("CRPIX2", crefpixC2, "Reference pixel on axis 2");
